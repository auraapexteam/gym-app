...
const revenueData = [
  { month: 'Jan', memberships: 520000, nutrition: 82000, classes: 38000 },
  { month: 'Feb', memberships: 580000, nutrition: 95000, classes: 45000 },
  { month: 'Mar', memberships: 560000, nutrition: 88000, classes: 42000 },
  { month: 'Apr', memberships: 620000, nutrition: 102000, classes: 48000 },
  { month: 'May', memberships: 680000, nutrition: 110000, classes: 52000 },
  { month: 'Jun', memberships: 650000, nutrition: 105000, classes: 50000 },
  { month: 'Jul', memberships: 690000, nutrition: 118000, classes: 56000 },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
        <Card className="lg:col-span-2">
          <CardHeader className="p-6 pb-4">
            ...
            <p className="text-xs text-aura-muted mt-0.5">Memberships, nutrition and classes revenue</p>
          </CardHeader>
          <CardContent className="p-6 pt-0">
            <ResponsiveContainer width="100%" height={240}>
              <AreaChart data={revenueData} margin={{ top: 5, right: 5, left: -10, bottom: 0 }}>
                ...
                <Area type="monotone" dataKey="classes" name="Classes" stroke="#F97316" strokeWidth={2} fill="url(#clsGrad)" dot={false} />
              </AreaChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>

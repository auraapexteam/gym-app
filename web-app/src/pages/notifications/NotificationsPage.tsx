...
const mockNotifications: Notification[] = [
  ...
  { id: '6', title: 'Capacity Alert', message: 'Strength floor reached peak usage on Friday evening. Add staff coverage for the next rush window.', type: 'info', isRead: true, createdAt: new Date(Date.now() - 48 * 3600000).toISOString() },
